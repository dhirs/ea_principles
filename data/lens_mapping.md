...
## GENREL — Reliability [PARTIAL — GENREL01 + GENREL03 walked; GENREL02/04/05/06 TODO]
...
> Note: GENREL04 (Prompt management — version control for prompts) is the reliability-framed twin of **GO3B1-01** (prompt registry); GENREL05/06 (distributed availability / compute) remain unwalked. To be enumerated as the pillar comes into focus.
