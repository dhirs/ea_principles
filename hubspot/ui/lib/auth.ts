// Single-user auth for the CRM. Credentials are hardcoded (internal tool).
// Stateless signed-session cookie using the Web Crypto API only (no node:crypto),
// so it runs in BOTH the Edge middleware and Node route handlers.
// Token shape: base64url(JSON payload) + "." + base64url(HMAC-SHA256 of payload).

// --- the one allowed login ---
const AUTH_EMAIL = "dsaxena@gmail.com";
const AUTH_PASSWORD = "756y6764Rt£@i9";
